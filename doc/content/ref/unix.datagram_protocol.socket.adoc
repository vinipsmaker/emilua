+++
title = "unix.datagram_protocol.socket"
+++

[source,lua]
----
local sock = unix.datagram_protocol.socket.new()
sock.open()
...
=== `new() -> unix.datagram_protocol.socket`

Constructor.

=== `pair() -> unix.datagram_protocol.socket, unix.datagram_protocol.socket`
