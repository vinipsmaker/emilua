+++
title = "unix.stream_protocol.socket"
+++

[source,lua]
----
local a, b = unix.stream_protocol.socket.pair()
...
=== `new() -> unix.stream_protocol.socket`

Constructor.

=== `pair() -> unix.stream_protocol.socket, unix.stream_protocol.socket`
